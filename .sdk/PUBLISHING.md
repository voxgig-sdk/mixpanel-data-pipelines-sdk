...
|---|---|---|
| `js/` | @voxgig-sdk/mixpanel-data-pipelines-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/mixpanel-data-pipelines | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/mixpanel-data-pipelines-js \
      --repository voxgig-sdk/mixpanel-data-pipelines-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/mixpanel-data-pipelines-js` shows it, and
`npm trust revoke @voxgig-sdk/mixpanel-data-pipelines-js --id=<id>` removes it.
