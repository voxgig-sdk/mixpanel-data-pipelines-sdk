# MixpanelDataPipelines SDK feature corpus test
#
...
def _client(kase):
    ...
    MixpanelDataPipelinesSDK(...), not MixpanelDataPipelinesSDK.test(...): the `test` feature is
    ...
    return MixpanelDataPipelinesSDK(opts)
