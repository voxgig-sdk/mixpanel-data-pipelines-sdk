...
describe('exists', async () => {
  ...
  //
  // MixpanelDataPipelinesSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof MixpanelDataPipelinesSDK, true,
      'MixpanelDataPipelinesSDK.test() must return a client synchronously')
  })
