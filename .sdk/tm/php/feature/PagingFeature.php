...
// MixpanelDataPipelines SDK paging feature
...
class MixpanelDataPipelinesPagingFeature extends MixpanelDataPipelinesBaseFeature
{
    ...
    private function _graphql_pre_request(MixpanelDataPipelinesContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(MixpanelDataPipelinesContext $ctx): bool
    {
