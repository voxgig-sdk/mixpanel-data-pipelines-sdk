...
// MixpanelDataPipelines SDK utility type

class MixpanelDataPipelinesUtility
{
    ...
    public static function copy(MixpanelDataPipelinesUtility $src): MixpanelDataPipelinesUtility
    {
        $u = new MixpanelDataPipelinesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
