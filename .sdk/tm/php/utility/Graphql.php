...
// MixpanelDataPipelines SDK utility: graphql
//
...
class MixpanelDataPipelinesGraphql
{
    ...
    // equivalent.
    public static function body(MixpanelDataPipelinesContext $ctx): mixed
    {
    ...
    public static function errors(MixpanelDataPipelinesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
