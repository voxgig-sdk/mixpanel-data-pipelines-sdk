...
// MixpanelDataPipelines SDK utility: fetcher

class MixpanelDataPipelinesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MixpanelDataPipelinesSDK/1.0)';
    ...
    public static function call(MixpanelDataPipelinesContext $ctx, string $fullurl, array $fetchdef): array
    {
