...
// MixpanelDataPipelines SDK utility: make_options

class MixpanelDataPipelinesMakeOptions
{
    ...
    public static function call(MixpanelDataPipelinesContext $ctx): array
    {
        ...
        //
        // `MixpanelDataPipelinesSchema::optspec()` is built from the model:
        ...
        $optspec = MixpanelDataPipelinesSchema::optspec();
