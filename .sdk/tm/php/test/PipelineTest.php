...
// MixpanelDataPipelines SDK pipeline test
//
...
{
    private static function utility(): MixpanelDataPipelinesUtility
    {
        return new MixpanelDataPipelinesUtility();
    }
    ...
    private static function ctx(array $over = []): MixpanelDataPipelinesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MixpanelDataPipelinesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MixpanelDataPipelinesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MixpanelDataPipelinesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MixpanelDataPipelinesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MixpanelDataPipelinesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MixpanelDataPipelinesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MixpanelDataPipelinesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MixpanelDataPipelinesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MixpanelDataPipelinesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MixpanelDataPipelinesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MixpanelDataPipelinesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MixpanelDataPipelinesResponse([]),
            'result' => new MixpanelDataPipelinesResult([]),
        ]);
        [, $err] = MixpanelDataPipelinesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MixpanelDataPipelinesSpec([]),
            'response' => null,
            'result' => new MixpanelDataPipelinesResult([]),
        ]);
        [, $err] = MixpanelDataPipelinesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MixpanelDataPipelinesSpec(['step' => 's']),
            'response' => new MixpanelDataPipelinesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MixpanelDataPipelinesResult([]),
        ]);
        [, $err] = MixpanelDataPipelinesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MixpanelDataPipelinesSpec(['step' => 's']),
            'response' => new MixpanelDataPipelinesResponse(self::resp(200, ['v' => 1])),
            'result' => new MixpanelDataPipelinesResult([]),
        ]);
        [, $err] = MixpanelDataPipelinesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MixpanelDataPipelinesSpec(['step' => 's']),
            'response' => new MixpanelDataPipelinesResponse(self::resp(200, ['v' => 2])),
            'result' => new MixpanelDataPipelinesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MixpanelDataPipelinesMakeResponse::call($ctx);
    ...
    {
        $preset = new MixpanelDataPipelinesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MixpanelDataPipelinesSpec([]),
            'response' => new MixpanelDataPipelinesResponse([]),
            'result' => new MixpanelDataPipelinesResult([]),
        ...
        [$got, $err] = MixpanelDataPipelinesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MixpanelDataPipelinesResult([])]);
        [, $err] = MixpanelDataPipelinesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MixpanelDataPipelinesSpec([]), 'result' => null]);
        [, $err] = MixpanelDataPipelinesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MixpanelDataPipelinesSpec(['step' => 's']),
            'result' => new MixpanelDataPipelinesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MixpanelDataPipelinesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MixpanelDataPipelinesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MixpanelDataPipelinesSpec(['step' => 's']),
            'result' => new MixpanelDataPipelinesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MixpanelDataPipelinesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MixpanelDataPipelinesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MixpanelDataPipelinesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MixpanelDataPipelinesSpec([]),
            'result' => new MixpanelDataPipelinesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MixpanelDataPipelinesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MixpanelDataPipelinesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MixpanelDataPipelinesError('boom', 'boom');
        $utility->fetcher = function (MixpanelDataPipelinesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MixpanelDataPipelinesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MixpanelDataPipelinesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MixpanelDataPipelinesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MixpanelDataPipelinesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MixpanelDataPipelinesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MixpanelDataPipelinesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MixpanelDataPipelinesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MixpanelDataPipelinesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MixpanelDataPipelinesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MixpanelDataPipelinesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MixpanelDataPipelinesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MixpanelDataPipelinesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MixpanelDataPipelinesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MixpanelDataPipelinesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MixpanelDataPipelinesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MixpanelDataPipelinesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MixpanelDataPipelinesResult(['ok' => false])]);
        $this->expectException(MixpanelDataPipelinesError::class);
        MixpanelDataPipelinesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MixpanelDataPipelinesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MixpanelDataPipelinesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MixpanelDataPipelinesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MixpanelDataPipelinesBaseFeature();
        $b = new MixpanelDataPipelinesBaseFeature();
        MixpanelDataPipelinesFeatureAdd::call($ctx, $a);
        MixpanelDataPipelinesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MixpanelDataPipelinesBaseFeature
    {
        $f = new MixpanelDataPipelinesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MixpanelDataPipelinesFeatureAdd::call($ctx, self::named_feature('a'));
        MixpanelDataPipelinesFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        MixpanelDataPipelinesFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        MixpanelDataPipelinesFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        MixpanelDataPipelinesFeatureAdd::call($ctx, $replace);
        ...
        MixpanelDataPipelinesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MixpanelDataPipelinesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MixpanelDataPipelinesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MixpanelDataPipelinesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MixpanelDataPipelinesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MixpanelDataPipelinesResponse(['headers' => null]),
            'result' => new MixpanelDataPipelinesResult([]),
        ]);
        MixpanelDataPipelinesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MixpanelDataPipelinesResultBody::call($ctx);
