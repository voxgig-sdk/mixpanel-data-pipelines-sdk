...
func registerSDKWords(r *eng.Registry, client *sdk.MixpanelDataPipelinesSDK) {
...
func runOp(client *sdk.MixpanelDataPipelinesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
