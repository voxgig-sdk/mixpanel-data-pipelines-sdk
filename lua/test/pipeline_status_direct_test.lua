...
describe("PipelineStatusDirect", function()
  it("should direct-list-pipeline_status", function()
    local setup = pipeline_status_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-pipeline_status", setup.live and "live" or "unit")
