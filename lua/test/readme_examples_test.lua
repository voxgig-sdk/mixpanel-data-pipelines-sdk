...
local SDK_MODULE = "mixpanel-data-pipelines_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["create"] = { ["test01"] = { id = "test01" } }, ["delete_pipeline"] = { ["test01"] = { id = "test01" } }, ["edit"] = { ["test01"] = { id = "test01" } }, ["pause"] = { ["test01"] = { id = "test01" } }, ["pipeline_status"] = { ["test01"] = { id = "test01" } }, ["resume"] = { ["test01"] = { id = "test01" } }, ["retrieve_pipeline"] = { ["test01"] = { id = "test01" } } } }'
