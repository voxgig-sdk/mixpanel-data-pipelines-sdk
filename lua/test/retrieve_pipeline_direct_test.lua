...
describe("RetrievePipelineDirect", function()
  it("should direct-load-retrieve_pipeline", function()
    local setup = retrieve_pipeline_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-retrieve_pipeline", setup.live and "live" or "unit")
