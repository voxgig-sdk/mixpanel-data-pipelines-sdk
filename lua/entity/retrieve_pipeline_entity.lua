...
local RetrievePipelineEntity = {}
RetrievePipelineEntity.__index = RetrievePipelineEntity


function RetrievePipelineEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RetrievePipelineEntity)
  self._name = "retrieve_pipeline"
  self._client = client
...
function RetrievePipelineEntity:get_name()
  return self._name
end


function RetrievePipelineEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RetrievePipelineEntity.new(self._client, opts)
end
...
function RetrievePipelineEntity:mark_deleted()
  self._deleted = true
end


function RetrievePipelineEntity:deleted()
  return true == self._deleted
end


function RetrievePipelineEntity:data_set(args)
  if args ~= nil then
...
function RetrievePipelineEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RetrievePipelineEntity:match_set(args)
  if args ~= nil then
...
function RetrievePipelineEntity:match_get()
...
function RetrievePipelineEntity:stream(action, args, callopts)
...
---@param reqmatch RetrievePipelineLoadMatch
---@param ctrl? table
---@return RetrievePipeline
---@return string? err
function RetrievePipelineEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function RetrievePipelineEntity:_run_op(ctx, post_done)
  local utility = self._utility
