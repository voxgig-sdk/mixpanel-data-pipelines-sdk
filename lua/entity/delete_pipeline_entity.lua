...
local DeletePipelineEntity = {}
DeletePipelineEntity.__index = DeletePipelineEntity


function DeletePipelineEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeletePipelineEntity)
  self._name = "delete_pipeline"
  self._client = client
...
function DeletePipelineEntity:get_name()
  return self._name
end


function DeletePipelineEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DeletePipelineEntity.new(self._client, opts)
end
...
function DeletePipelineEntity:mark_deleted()
  self._deleted = true
end


function DeletePipelineEntity:deleted()
  return true == self._deleted
end


function DeletePipelineEntity:data_set(args)
  if args ~= nil then
...
function DeletePipelineEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeletePipelineEntity:match_set(args)
  if args ~= nil then
...
function DeletePipelineEntity:match_get()
...
function DeletePipelineEntity:stream(action, args, callopts)
...
---@param reqdata DeletePipelineCreateData
---@param ctrl? table
---@return DeletePipeline
---@return string? err
function DeletePipelineEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function DeletePipelineEntity:_run_op(ctx, post_done)
  local utility = self._utility
