...
local PipelineStatusEntity = {}
PipelineStatusEntity.__index = PipelineStatusEntity


function PipelineStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PipelineStatusEntity)
  self._name = "pipeline_status"
  self._client = client
...
function PipelineStatusEntity:get_name()
  return self._name
end


function PipelineStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PipelineStatusEntity.new(self._client, opts)
end
...
function PipelineStatusEntity:mark_deleted()
  self._deleted = true
end


function PipelineStatusEntity:deleted()
  return true == self._deleted
end


function PipelineStatusEntity:data_set(args)
  if args ~= nil then
...
function PipelineStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PipelineStatusEntity:match_set(args)
  if args ~= nil then
...
function PipelineStatusEntity:match_get()
...
function PipelineStatusEntity:stream(action, args, callopts)
...
---@param reqmatch PipelineStatusListMatch
---@param ctrl? table
---@return PipelineStatus[]
---@return string? err
function PipelineStatusEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function PipelineStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
