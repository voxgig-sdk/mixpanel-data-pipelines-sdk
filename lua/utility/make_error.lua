...
local function make_error_util(ctx, err)
  ...
  local msg = "MixpanelDataPipelinesSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = MixpanelDataPipelinesError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == MixpanelDataPipelinesError then
