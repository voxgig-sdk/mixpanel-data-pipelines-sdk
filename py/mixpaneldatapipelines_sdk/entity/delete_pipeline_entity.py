...
class DeletePipelineEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DeletePipelineEntity(self._client, opts)
    ...
    def data_get(self) -> DeletePipeline:
    ...
    def match_get(self) -> DeletePipeline:
    ...
    def create(self, reqdata: DeletePipelineCreateData, ctrl=None) -> DeletePipeline:
        utility = self._utility
