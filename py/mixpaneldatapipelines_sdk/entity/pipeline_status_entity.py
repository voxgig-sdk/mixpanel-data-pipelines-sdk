...
class PipelineStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PipelineStatusEntity(self._client, opts)
    ...
    def data_get(self) -> PipelineStatus:
    ...
    def match_get(self) -> PipelineStatus:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PipelineStatus]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PipelineStatus().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
