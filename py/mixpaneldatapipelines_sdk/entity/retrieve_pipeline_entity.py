...
from mixpaneldatapipelines_sdk.mixpaneldatapipelines_types import (
    RetrievePipeline,
...
class RetrievePipelineEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RetrievePipelineEntity(self._client, opts)
    ...
    def data_get(self) -> RetrievePipeline:
    ...
    def match_get(self) -> RetrievePipeline:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RetrievePipeline:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RetrievePipeline().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
