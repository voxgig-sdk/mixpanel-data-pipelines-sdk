# MixpanelDataPipelines SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MixpanelDataPipelinesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MixpanelDataPipelinesSDK(...) and MixpanelDataPipelinesSDK.test(...) become
#      MixpanelDataPipelinesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mixpaneldatapipelines_sdk"
_SDK_CLASS = "MixpanelDataPipelinesSDK"
...
_ENTITIES = {
    ...
    "Resume": "resume",
    "RetrievePipeline": "retrieve_pipeline",
}
