...
const testSeed = `map[string]any{"entity": map[string]any{"create": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "delete_pipeline": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "edit": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pause": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pipeline_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "resume": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "retrieve_pipeline": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
