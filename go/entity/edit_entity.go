...
func NewEditEntity(client *core.MixpanelDataPipelinesSDK, entopts map[string]any) *EditEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EditEntity) GetName() string { return e.name }
...
func (e *EditEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EditEntity) Deleted() bool {
	return e.deleted
}


func (e *EditEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEditEntity(e.client, opts)
}

func (e *EditEntity) Data(args ...any) any {
...
func (e *EditEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Edit; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EditEntity) DataTyped(data ...Edit) Edit {
	if len(data) > 0 {
		return typedFrom[Edit](e.Data(asMap(data[0])))
	}
	return typedFrom[Edit](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Edit (all fields
// optional at the wire level).
func (e *EditEntity) MatchTyped(match ...Edit) Edit {
	if len(match) > 0 {
		return typedFrom[Edit](e.Match(asMap(match[0])))
	}
	return typedFrom[Edit](e.Match())
}
...
func (e *EditEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EditEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EditEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EditEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EditCreateData and returns an Edit. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EditEntity) CreateTyped(reqdata EditCreateData, ctrl map[string]any) (Edit, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Edit{}, err
	}
	return typedFrom[Edit](res), nil
}



func (e *EditEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EditEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EditEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
