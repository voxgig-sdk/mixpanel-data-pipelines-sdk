...
func NewCreateEntity(client *core.MixpanelDataPipelinesSDK, entopts map[string]any) *CreateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CreateEntity) GetName() string { return e.name }
...
func (e *CreateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CreateEntity) Deleted() bool {
	return e.deleted
}


func (e *CreateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCreateEntity(e.client, opts)
}

func (e *CreateEntity) Data(args ...any) any {
...
func (e *CreateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Create; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CreateEntity) DataTyped(data ...Create) Create {
	if len(data) > 0 {
		return typedFrom[Create](e.Data(asMap(data[0])))
	}
	return typedFrom[Create](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Create (all fields
// optional at the wire level).
func (e *CreateEntity) MatchTyped(match ...Create) Create {
	if len(match) > 0 {
		return typedFrom[Create](e.Match(asMap(match[0])))
	}
	return typedFrom[Create](e.Match())
}
...
func (e *CreateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CreateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CreateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CreateEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CreateCreateData and returns an Create. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CreateEntity) CreateTyped(reqdata CreateCreateData, ctrl map[string]any) (Create, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Create{}, err
	}
	return typedFrom[Create](res), nil
}



func (e *CreateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CreateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CreateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
