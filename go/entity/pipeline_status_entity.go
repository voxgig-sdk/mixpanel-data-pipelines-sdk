...
func NewPipelineStatusEntity(client *core.MixpanelDataPipelinesSDK, entopts map[string]any) *PipelineStatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PipelineStatusEntity) GetName() string { return e.name }
...
func (e *PipelineStatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PipelineStatusEntity) Deleted() bool {
	return e.deleted
}


func (e *PipelineStatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPipelineStatusEntity(e.client, opts)
}

func (e *PipelineStatusEntity) Data(args ...any) any {
...
func (e *PipelineStatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PipelineStatus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PipelineStatusEntity) DataTyped(data ...PipelineStatus) PipelineStatus {
	if len(data) > 0 {
		return typedFrom[PipelineStatus](e.Data(asMap(data[0])))
	}
	return typedFrom[PipelineStatus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PipelineStatus (all fields
// optional at the wire level).
func (e *PipelineStatusEntity) MatchTyped(match ...PipelineStatus) PipelineStatus {
	if len(match) > 0 {
		return typedFrom[PipelineStatus](e.Match(asMap(match[0])))
	}
	return typedFrom[PipelineStatus](e.Match())
}
...
func (e *PipelineStatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PipelineStatusEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PipelineStatusEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PipelineStatusListMatch and returns []PipelineStatus. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PipelineStatusEntity) ListTyped(reqmatch PipelineStatusListMatch, ctrl map[string]any) ([]PipelineStatus, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PipelineStatus](res), nil
}



func (e *PipelineStatusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PipelineStatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PipelineStatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PipelineStatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
