...
func NewResumeEntity(client *core.MixpanelDataPipelinesSDK, entopts map[string]any) *ResumeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ResumeEntity) GetName() string { return e.name }
...
func (e *ResumeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ResumeEntity) Deleted() bool {
	return e.deleted
}


func (e *ResumeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewResumeEntity(e.client, opts)
}

func (e *ResumeEntity) Data(args ...any) any {
...
func (e *ResumeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Resume; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ResumeEntity) DataTyped(data ...Resume) Resume {
	if len(data) > 0 {
		return typedFrom[Resume](e.Data(asMap(data[0])))
	}
	return typedFrom[Resume](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Resume (all fields
// optional at the wire level).
func (e *ResumeEntity) MatchTyped(match ...Resume) Resume {
	if len(match) > 0 {
		return typedFrom[Resume](e.Match(asMap(match[0])))
	}
	return typedFrom[Resume](e.Match())
}
...
func (e *ResumeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ResumeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ResumeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ResumeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ResumeCreateData and returns an Resume. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ResumeEntity) CreateTyped(reqdata ResumeCreateData, ctrl map[string]any) (Resume, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Resume{}, err
	}
	return typedFrom[Resume](res), nil
}



func (e *ResumeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ResumeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ResumeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
