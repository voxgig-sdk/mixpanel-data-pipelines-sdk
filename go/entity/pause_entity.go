...
func NewPauseEntity(client *core.MixpanelDataPipelinesSDK, entopts map[string]any) *PauseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PauseEntity) GetName() string { return e.name }
...
func (e *PauseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PauseEntity) Deleted() bool {
	return e.deleted
}


func (e *PauseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPauseEntity(e.client, opts)
}

func (e *PauseEntity) Data(args ...any) any {
...
func (e *PauseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Pause; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PauseEntity) DataTyped(data ...Pause) Pause {
	if len(data) > 0 {
		return typedFrom[Pause](e.Data(asMap(data[0])))
	}
	return typedFrom[Pause](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Pause (all fields
// optional at the wire level).
func (e *PauseEntity) MatchTyped(match ...Pause) Pause {
	if len(match) > 0 {
		return typedFrom[Pause](e.Match(asMap(match[0])))
	}
	return typedFrom[Pause](e.Match())
}
...
func (e *PauseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PauseEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PauseEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PauseEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PauseCreateData and returns an Pause. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PauseEntity) CreateTyped(reqdata PauseCreateData, ctrl map[string]any) (Pause, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Pause{}, err
	}
	return typedFrom[Pause](res), nil
}



func (e *PauseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PauseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PauseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
