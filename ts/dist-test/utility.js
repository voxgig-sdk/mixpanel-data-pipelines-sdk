...
function envOverride(m) {
    if ('TRUE' === process.env.MIXPANEL_DATA_PIPELINES_TEST_LIVE ||
        'TRUE' === process.env.MIXPANEL_DATA_PIPELINES_TEST_OVERRIDE) {
    ...
    m.MIXPANEL_DATA_PIPELINES_TEST_EXPLAIN = process.env.MIXPANEL_DATA_PIPELINES_TEST_EXPLAIN || m.MIXPANEL_DATA_PIPELINES_TEST_EXPLAIN;
    return m;
}
