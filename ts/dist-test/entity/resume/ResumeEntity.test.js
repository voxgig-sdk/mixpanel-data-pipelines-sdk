...
(0, node_test_1.describe)('ResumeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'resume.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != resume_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/resume/ResumeTestData.json');
    ...
    let idmap = transform(['resume01', 'resume02', 'resume03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ResumeEntity.test.js.map