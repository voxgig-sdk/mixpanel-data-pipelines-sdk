...
(0, node_test_1.describe)('DeletePipelineEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'delete_pipeline.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != delete_pipeline_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/delete_pipeline/DeletePipelineTestData.json');
    ...
    let idmap = transform(['delete_pipeline01', 'delete_pipeline02', 'delete_pipeline03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DeletePipelineEntity.test.js.map