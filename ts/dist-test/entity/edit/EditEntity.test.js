...
(0, node_test_1.describe)('EditEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'edit.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != edit_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/edit/EditTestData.json');
    ...
    let idmap = transform(['edit01', 'edit02', 'edit03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EditEntity.test.js.map