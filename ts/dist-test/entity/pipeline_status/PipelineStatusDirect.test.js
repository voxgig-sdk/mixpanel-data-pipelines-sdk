...
(0, node_test_1.describe)('PipelineStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MixpanelDataPipelinesSDK({
    ...
    (0, node_test_1.test)('direct-list-pipeline_status', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-pipeline_status', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MixpanelDataPipelinesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        ...
        let idmap = env['MIXPANEL_DATA_PIPELINES_TEST_PIPELINE_STATUS_ENTID'];
    ...
    const client = new __1.MixpanelDataPipelinesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PipelineStatusDirect.test.js.map