# MixpanelDataPipelines TypeScript SDK Reference

Complete API reference for the MixpanelDataPipelines TypeScript SDK.
...
```ts
const results = await client.PipelineStatus().list({ name: "example", project_id: 1 })
```
