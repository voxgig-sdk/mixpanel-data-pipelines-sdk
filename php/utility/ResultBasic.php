...
// MixpanelDataPipelines SDK utility: result_basic

class MixpanelDataPipelinesResultBasic
{
    public static function call(MixpanelDataPipelinesContext $ctx): ?MixpanelDataPipelinesResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof MixpanelDataPipelinesError) ? $result->err->msg : (string)$result->err;
