...
// MixpanelDataPipelines SDK utility: feature_init

class MixpanelDataPipelinesFeatureInit
{
    public static function call(MixpanelDataPipelinesContext $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {
