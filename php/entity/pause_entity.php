...
// MixpanelDataPipelines SDK Pause entity
...
class PauseEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PauseEntity($this->_client, $opts);
    }

    /**
     * @param Pause|array $args Pause data (assoc-array) to store.
     */
    ...
    /**
     * @return Pause|array The current Pause data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Pause fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Pause fields).
     */
     ...
     * Create a new Pause.
     *
     * @param PauseCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PauseCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Pause|array The created Pause as an assoc-array at the
