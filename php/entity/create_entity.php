...
// MixpanelDataPipelines SDK Create entity
...
class CreateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CreateEntity($this->_client, $opts);
    }

    /**
     * @param Create|array $args Create data (assoc-array) to store.
     */
    ...
    /**
     * @return Create|array The current Create data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Create fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Create fields).
     */
     ...
     * Create a new Create.
     *
     * @param CreateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CreateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Create|array The created Create as an assoc-array at the
