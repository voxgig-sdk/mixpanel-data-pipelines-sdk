...
// MixpanelDataPipelines SDK Edit entity
...
class EditEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EditEntity($this->_client, $opts);
    }

    /**
     * @param Edit|array $args Edit data (assoc-array) to store.
     */
    ...
    /**
     * @return Edit|array The current Edit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Edit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Edit fields).
     */
     ...
     * Create a new Edit.
     *
     * @param EditCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EditCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Edit|array The created Edit as an assoc-array at the
