...
// MixpanelDataPipelines SDK Resume entity
...
class ResumeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ResumeEntity($this->_client, $opts);
    }

    /**
     * @param Resume|array $args Resume data (assoc-array) to store.
     */
    ...
    /**
     * @return Resume|array The current Resume data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Resume fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Resume fields).
     */
     ...
     * Create a new Resume.
     *
     * @param ResumeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ResumeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Resume|array The created Resume as an assoc-array at the
