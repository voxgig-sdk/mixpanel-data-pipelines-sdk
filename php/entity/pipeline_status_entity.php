...
// MixpanelDataPipelines SDK PipelineStatus entity
...
class PipelineStatusEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PipelineStatusEntity($this->_client, $opts);
    }

    /**
     * @param PipelineStatus|array $args PipelineStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return PipelineStatus|array The current PipelineStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PipelineStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PipelineStatus fields).
     */
    ...
    /**
     * List PipelineStatus items matching the given filter.
     *
     * @param PipelineStatusListMatch|array|null $reqmatch Match filter (any subset
     *   of PipelineStatus fields) as an assoc-array; PipelineStatusListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PipelineStatus[]|array A list of PipelineStatus items as assoc-arrays at
     *   the SDK boundary; throws MixpanelDataPipelinesError on failure (item-5 convention).
     */
