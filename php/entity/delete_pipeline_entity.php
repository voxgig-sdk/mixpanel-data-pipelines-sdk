...
// MixpanelDataPipelines SDK DeletePipeline entity
...
class DeletePipelineEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeletePipelineEntity($this->_client, $opts);
    }

    /**
     * @param DeletePipeline|array $args DeletePipeline data (assoc-array) to store.
     */
    ...
    /**
     * @return DeletePipeline|array The current DeletePipeline data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeletePipeline fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeletePipeline fields).
     */
    ...
    /**
     * Create a new DeletePipeline.
     *
     * @param DeletePipelineCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeletePipelineCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeletePipeline|array The created DeletePipeline as an assoc-array at the
