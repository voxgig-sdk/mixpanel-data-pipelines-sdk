...
// MixpanelDataPipelines SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MixpanelDataPipelinesSDK::test)
...
{
    private const SDK_CLASS = 'MixpanelDataPipelinesSDK';
    ...
    private const SDK_BASE = 'mixpaneldatapipelines_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../mixpaneldatapipelines_sdk.php';
