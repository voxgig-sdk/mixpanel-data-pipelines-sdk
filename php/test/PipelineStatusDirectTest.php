...
class PipelineStatusDirectTest extends TestCase
{
    public function test_direct_list_pipeline_status(): void
    {
        $setup = pipeline_status_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-pipeline_status", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function pipeline_status_direct_setup($mockres)
{
