...
class MixpanelDataPipelinesTestRunner
{
    ...
    {
        $live = self::getenv('MIXPANEL_DATA_PIPELINES_TEST_LIVE');
        $override = self::getenv('MIXPANEL_DATA_PIPELINES_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MIXPANEL_DATA_PIPELINES_TEST_EXPLAIN');
...
class_alias('MixpanelDataPipelinesTestRunner', 'Runner');
class_alias('MixpanelDataPipelinesHelpers', 'Helpers');
