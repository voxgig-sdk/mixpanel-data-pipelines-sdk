...
// MixpanelDataPipelines SDK ratelimit feature
...
class MixpanelDataPipelinesRatelimitFeature extends MixpanelDataPipelinesBaseFeature
{
    ...
    private function _acquire(MixpanelDataPipelinesContext $ctx): void
    {
    ...
    private function _track(MixpanelDataPipelinesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
