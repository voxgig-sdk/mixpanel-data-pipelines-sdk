...
// MixpanelDataPipelines SDK timeout feature
...
class MixpanelDataPipelinesTimeoutFeature extends MixpanelDataPipelinesBaseFeature
{
    ...
    private function _with_timeout(MixpanelDataPipelinesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MixpanelDataPipelinesContext $_ctx, float $ms): void
    {
        $client = $this->client;
